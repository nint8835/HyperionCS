...
export type InternalFetcherOptions<TBody, THeaders, TQueryParams, TPathParams> = {
  url: string;
  method: string;
  body?: TBody;
  headers?: THeaders;
...
>({
  ...
  queryParams,
  signal,
}: InternalFetcherOptions<TBody, THeaders, TQueryParams, TPathParams>): Promise<TData> {
